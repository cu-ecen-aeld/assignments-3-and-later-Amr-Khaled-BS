...
```
From the above call trace logs, the fault has occured in faulty_write function at an offset of 0x10.
```
pc : faulty_write+0x10/0x20 [faulty]
```
...
0000000000000000 <faulty_write>:
  ...
  1c:   d503201f        nop
```
 from above objdump of faulty.ko:
 A value of 0x0 is stored to register x1, then at 0x10 value of wzr register(which holds value 0) is attempted to write to register pointed by x1 which is 0x0. 
 
 This causes segmentation fault as an attempt
