...
MODULE_AUTHOR("Amr Khaled"); /** TODO: fill in your name **/
                  ...
                  loff_t *f_pos)
{
    ...
    else
    {
        ...
        struct aesd_buffer_entry *entry_at_pos = aesd_circular_buffer_find_entry_offset_for_fpos(&aesd_device.circular_buff, *f_pos, &entry_offset_byte_rtn);
        if (entry_at_pos)
        {
